...
public class SettingsFragment extends PreferenceFragment implements OnTimeSetListener {
...
//		t.send(new HitBuilders.AppViewBuilder().build());
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		mPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
			...
			@Override
			public boolean onPreferenceClick(Preference preference) {
				TimePickerDialog mDialog = new TimePickerDialog(getActivity(), SettingsFragment.this, hour, min, false);
				mDialog.show();
				return false;
			}
